    ...
    $.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
        ...
        return this.each(function () {
            if (!this.grid) {
                ...
                $(v).attr({
                    id: "gbox_" + this.id,
                    dir: h
                }).insertBefore(j), $(j).attr("id", "gview_" + this.id).appendTo(v), $("<div " + k(d.p.styleUI + ".common", "overlay", !1, "jqgrid-overlay") + " id='lui_" + this.id + "'></div>").insertBefore(j), $("<div " + k(l, "loadingBox", !1, "loading") + " id='load_" + this.id + "'>" + $.jgrid.getRegional(d, "defaults.loadtext", this.p.loadtext) + "<div class='sk-bounce1'></div><div class='sk-bounce2'></div><div class='sk-bounce3'></div></div>").insertBefore(j), $(this).attr({
                    role: "presentation",
                ...
                var w, x = ["shiftKey", "altKey", "ctrlKey"], y = function (a, b) {
                    ...
                    if(0 == g && !h.defaultValue) g = '' ;if ('&#160;' == g && h.defaultValue) { g = h.defaultValue };
                    return g
                    ...
                    return '<td role="gridcell" ' + h + ">" + g + "<label for='jpg_"+d.p.id+"_"+a+"'></label></td>"
                    ...
                    if(!a.length) $('.ui-jqgrid-sdiv').remove();
                    var f = new Date;
                    if (a) {
                        -1 !== d.p.treeANode || d.p.scroll ? b = b > 1 ? b : 1 : (H.call(d, !1, !0), b = 1);
                ...
                this.p.multiselect && (this.p.colNames.unshift("<input role='checkbox' id='cb_" + this.p.id + "' class='cbox' type='checkbox'/><label for='cb_" + this.p.id + "'></label>"), this.p.colModel.unshift({
                    name: "cb",
                    ...
                    if (g = h.p.colModel[b], d = g.name, "subgrid" !== d && "cb" !== d && "rn" !== d) {
                        if (f = $("td:eq(" + b + ")", h.rows[a]), g.editable !== !0 || c !== !0 || f.hasClass("not-editable-cell") || $.isFunction(h.p.isCellEditable) && !h.p.isCellEditable.call(h, d, a, b))parseInt(h.p.iCol, 10) >= 0 && parseInt(h.p.iRow, 10) >= 0 && $(h.rows[h.p.iRow]).removeClass("selected-row " + j).find("td:eq(" + h.p.iCol + ")").removeClass("edit-cell " + i), f.addClass("edit-cell " + i), $(h.rows[a]).addClass("selected-row " + j), e = f.html().replace(/\&#160\;/gi, ""), $(h).triggerHandler("jqGridSelectCell", [h.rows[a].id, d, e, a, b]), $.isFunction(h.p.onSelectCell) && h.p.onSelectCell.call(h, h.rows[a].id, d, e, a, b); else {
                            ...
                            $.inArray(g.edittype, ["text", "textarea", "password", "select"]) > -1 && $(o).addClass(k), $(f).html("").append(o).attr("tabindex", "0"), $.jgrid.bindEv.call(h, o, n), window.setTimeout(function () {
                                ...
                                if (27 === c.keyCode && ($("input.hasDatepicker", f).length > 0 ? $(".ui-datepicker").is(":hidden") ? $(h).jqGrid("restoreCell", a, b) : $("input.hasDatepicker", f).datepicker("hide") : $(h).jqGrid("restoreCell", a, b)), 13 === c.keyCode && !c.shiftKey) {$(this).trigger('blur');return $(h).jqGrid("saveCell", a, b), !1;}
                                if (9 === c.keyCode) {
                                    if (h.grid.hDiv.loading)return !1;
                                    c.shiftKey ? $(h).jqGrid("prevCell", a, b) : $(h).jqGrid("nextCell", a, b)
                                }
                                c.stopPropagation()
                            }), $("input, select, textarea", f).bind("blur", function (c) {
                                $(f).parent().find('.edit-cell').removeClass('edit-cell');
                        ...
                        if (h !== d.p.savedRow[c].v) {
                            ...
                            if (s[0] === !0) {
                                ...
                                window.setTimeout(function () {
                                    $.jgrid.info_dialog(e.errcap, s[1], f.bClose, {styleUI: d.p.styleUI})
        ...
        showModal: function (a) {
            ...
            switch (a) {
                ...
                default:
                    var B;
                    B = "button" === a ? "button" : "textbox", g = document.createElement("input"), g.type = a, g.value = c, f(g, b), "button" !== a && (d ? b.size || $(g).css({width: "100%"}) : b.size || (b.size = 20)), $(g).attr("role", B)
            }
            return g
            ...
            if (e) {
                if (g || (g = null != k.p.colNames ? k.p.colNames[b] : l[b].label), e.required === !0 && $.jgrid.isEmpty(a))return [!1,  m.required, ""];
                var n = e.required === !1 ? !1 : !0;
                if (e.number === !0 && (n !== !1 || !$.jgrid.isEmpty(a)) && isNaN(a))return [!1,  m.number, ""];
                if (void 0 !== e.minValue && !isNaN(e.minValue) && parseFloat(a) < parseFloat(e.minValue))return [!1,  m.minValue + " " + e.minValue, ""];
                if (void 0 !== e.maxValue && !isNaN(e.maxValue) && parseFloat(a) > parseFloat(e.maxValue))return [!1,  m.maxValue + " " + e.maxValue, ""];
                var o;
                if (e.email === !0 && !(n === !1 && $.jgrid.isEmpty(a) || (o = /^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i, o.test(a))))return [!1,  m.email, ""];
                if (e.integer === !0 && (n !== !1 || !$.jgrid.isEmpty(a))) {
                    if (isNaN(a))return [!1,  m.integer, ""];
                    if (a % 1 !== 0 || -1 !== a.indexOf("."))return [!1,  m.integer, ""]
                }
                if (e.date === !0 && !(n === !1 && $.jgrid.isEmpty(a) || (l[b].formatoptions && l[b].formatoptions.newformat ? (h = l[b].formatoptions.newformat, j = $.jgrid.getRegional(k, "formatter.date.masks"), j && j.hasOwnProperty(h) && (h = j[h])) : h = l[b].datefmt || "Y-m-d", $.jgrid.checkDate(h, a))))return [!1,  m.date + " - " + h, ""];
                if (e.time === !0 && !(n === !1 && $.jgrid.isEmpty(a) || $.jgrid.checkTime(a)))return [!1,  m.date + " - hh:mm (am/pm)", ""];
                if (e.url === !0 && !(n === !1 && $.jgrid.isEmpty(a) || (o = /^(((https?)|(ftp)):\/\/([\-\w]+\.)+\w{2,3}(\/[%\-\w]+(\.\w{2,})?)*(([\w\-\.\?\\\/+@&#;`~=%!]*)(\.\w{2,})?)*\/?)/i, o.test(a))))return [!1,  m.url, ""];
            ...
            return a = $.extend({
                ...
                if (!c.p.filterToolbar) {
                    ...
                    var d, e = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].filter, f = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].common, g = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].base, h = function () {
                        ...
                        $("#sopt_menu").remove(), d = parseInt(d, 10), g = parseInt(g, 10) + 8;
        ...
        setTreeNode: function (a, b) {
            return this.each(function () {
                ...
                if (c.grid && c.p.treeGrid)for (var d, e, f, g, h, i, j, k, l = c.p.expColInd, m = c.p.treeReader.expanded_field, n = c.p.treeReader.leaf_field, o = c.p.treeReader.level_field, p = c.p.treeReader.icon_field, q = c.p.treeReader.loaded, r = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].common; b > a;) {
                    ...
                    j = c.p.data[u], "nested" === c.p.treeGridModel && (j[n] || (d = parseInt(j[c.p.treeReader.left_field], 10), e = parseInt(j[c.p.treeReader.right_field], 10), j[n] = e === d + 1 ? "true" : "false", c.rows[a].cells[c.p._treeleafpos].innerHTML = j[n])), f = parseInt(j[o], 10), 0 === c.p.tree_root_level ? (g = f + 1, h = f) : (g = f, h = f - 1), i = "<div class='tree-wrap tree-wrap-" + c.p.direction + "' style='width:" + 8 * g + "px;'>", i += "<div style='" + ("rtl" === c.p.direction ? "right:" : "left:") + 8 * (h - 1) + "px;' class='" + r.icon_base + " ", void 0 !== j[q] && (j[q] = "true" === j[q] || j[q] === !0 ? !0 : !1), "true" === j[n] || j[n] === !0 ? (i += (void 0 !== j[p] && "" !== j[p] ? j[p] : c.p.treeIcons.leaf) + " tree-leaf treeclick", j[n] = !0, k = "leaf") : (j[n] = !1, k = ""), j[m] = ("true" === j[m] || j[m] === !0 ? !0 : !1) && (j[q] || void 0 === j[q]), i += j[m] === !1 ? j[n] === !0 ? "'" : c.p.treeIcons.plus + " tree-plus treeclick'" : j[n] === !0 ? "'" : c.p.treeIcons.minus + " tree-minus treeclick'", i += "></div></div>", $(c.rows[a].cells[l]).wrapInner("<span class='cell-wrapper" + k + "'></span>").prepend(i), f !== parseInt(c.p.tree_root_level, 10) && (s = $(c).jqGrid("isVisibleNode", j), 1 != f && $(c.rows[a]).css("display", "none")), $(c.rows[a].cells[l]).find("div.treeclick").bind("click", function (a) {
